...
# download.file("https://stopcovid19.metro.tokyo.lg.jp/data/130001_tokyo_covid19_patients_2022.csv", "130001_tokyo_covid19_patients_2022.csv", "auto")
...
ttoday<-tibble(date=c("2022-09-04"),cases=c(9635))
...
t001<-read_csv(file="130001_tokyo_covid19_patients_2022-1.csv",col_names = FALSE,skip=1)
t002<-read_csv(file="130001_tokyo_covid19_patients_2022-2.csv",col_names = FALSE,skip=1)
t01<-bind_rows(t000,t001,t002)
